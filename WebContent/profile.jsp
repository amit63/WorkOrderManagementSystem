...
<table>
  <tr>
   <td>
    <form name="profileform" action="/workordersystem/profileController?updateprofile" method="post">
    ...
    <td> <input name="firstname" value="${firstname}" type="text" maxlength="45" style=" border: none;  background: transparent " readonly>  </td>
 	...
 	<tr>
    <td> Phone: </td>
    <td> <input name="phone" value="${phone1}" type="number" maxlength="45">  </td>
 	<td> <input name="phoneerror"  value= "${phoneerror}" type="text"  style ="background-color: #F8F8FF; color: red; border: none; width: "  disabled="disabled" maxlength="60"> </td>
    </tr>
 	
 	<tr>
    <td> Email: </td>
    <td> <input name="email" value="${email}" type="email" maxlength="45">  </td>
 	<td> <input name="emailerror"  value= "${emailerror}" type="text"  style ="background-color: #F8F8FF; color: red; border: none; width: "  disabled="disabled" maxlength="60"> </td>
    </tr>
 <%-- 	<tr>
    <td> UTA ID: </td>
    <td> <input name="uta_id" value="${uta_id1}" type="uta_id" maxlength="45" style=" border: none;  background: transparent " readonly>  </td>
 	<td> <input name="utaiderror"  value= "${utaiderror}" type="text"  style ="background-color: #F8F8FF; color: red; border: none; width:"  disabled="disabled" maxlength="60"> </td>
    </tr>
 	 --%>
    ...
    <td> <input name="address" value="${address}" type="text" maxlength="100">  </td>
 	<td> <input name="addresserror"  value= "${addresserror}" type="text"  style ="background-color: #F8F8FF; color: red; border: none; width:"  disabled="disabled" maxlength="60"> </td>
    </tr>
	...
	<option value="WY">Wyoming</option>
 	...
 	<tr>
    <td> ZipCode: </td>
    <td> <input name="zipcode" value="${zipcode1}" type="number" maxlength="50">  </td>
 	 <td> <input name="zipcodeerror"  value= "${zipcodeerror}" type="text"  style ="background-color: white; color: red; border: none; width: 800px"  disabled="disabled" maxlength="60"> </td>
    </tr>
...
<input  type="submit" value="updateprofile"> </td>
